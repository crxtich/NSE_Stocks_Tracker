...
<body style="margin:0;background:#0B0D10;color:#F5F7FA;font-family:-apple-system,Segoe UI,Roboto,sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;">
  <div style="max-width:420px;padding:32px;text-align:center;">
    ...
    <a href="https://nse-tracker.crotich.com/" style="display:inline-block;margin-top:20px;color:#0B0D10;background:${accent};padding:10px 20px;border-radius:8px;text-decoration:none;font-weight:600;font-size:14px;">Back to the site</a>
  </div>
</body>
</html>`
